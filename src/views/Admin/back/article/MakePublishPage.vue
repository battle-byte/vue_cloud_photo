    ...
    <el-container style="height: 100%">
      ...
      <el-row>
        <view
          ...
          "
        >
          <ShowText :value="articleMessage.content"></ShowText>
<!--          <div style="width: 767.5px;"  class="ql-editor" v-html="articleMessage.content"></div>-->
        </view>
      </el-row>
    </el-container>
  </view>
...
import ShowTest from '@/components/ShowText.vue'
// 局部引入
