<template>
  <view class="AddAPP">
    <span style="font-size: 40px; padding-bottom: 20px; border-bottom: 20px">修改应用</span>
    ...
    <el-form :rules="rules" :model="AppMessage" ref="form" size="large" autocomplete="off">
      ...
      <el-form-item>
        <el-image style="width: 150px; height: 150px; padding-left: 5px" :src="urls" fit="fill" />
      </el-form-item>
    </el-form>
  </view>
</template>
...
import { addAppAPI, editAppAPI, getAppVOByIdAPI } from '@/service/AppController'
