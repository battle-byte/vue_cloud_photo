...
import { getPeriodicalOneAPI, handleEditPeriodicalAPI } from '@/service/PeriodicalController'
import type { periodical, updatePeriodical } from '@/types/Periodical'
...
//活动泛型
const periodicalMessage = ref<updatePeriodical>({})
...
//获取当前活动内容
const getPeriodicalOne = async () => {
  const res = await getPeriodicalOneAPI(props.id)
  periodicalMessage.value.periodicalName = res.data.periodicalName,
    periodicalMessage.value.indexArchiving = res.data.indexArchiving,
    periodicalMessage.value.publishTime = res.data.publishTime,
    periodicalMessage.value.frequency = res.data.frequency,
    periodicalMessage.value.peerReviewModel = res.data.peerReviewModel,
    periodicalMessage.value.elSSN = res.data.elSSN,
    periodicalMessage.value.eic = res.data.eIC
  periodicalMessage.value.publishingModel = res.data.publishingModel,
    periodicalMessage.value.apc = res.data.APC
}

//
const updateActive = async () => {
  const res = await handleEditPeriodicalAPI(
    {
      id: props.id,
